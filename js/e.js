...
$('document').ready(function(){
	...
	$('#play').click(function(){
		...
		$('body').css('backgroud-color','#fed2e5');
	...
	$('#bannar_coming').click(function(){
		...
		$('.decoracion').show().addClass('aos-init').attr('data-aos', 'fade-up').attr('data-aos-duration', '800');
		$('.titulo').show().addClass('aos-init').attr('data-aos', 'zoom-in').attr('data-aos-duration', '1200');
